...
#include <cmath>
#include <fstream>
//deklaracja u¿ycia przestrzeni nazw std
using namespace std;
class Wykladnicza {
public:
	double podstawa;
	...
	//przeci¹¿enie operatora * dla liczb "wyk³adniczych"
	//bêd¹ce metod¹ klasy Wykladnicza
...
//przeci¹¿enie operatora wypisywania dla liczb "wyk³adniczych"
//bêd¹ce funkcj¹
